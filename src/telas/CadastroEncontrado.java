 ...
 * @author ariel
 */
public class CadastroEncontrado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel20.setText("Cadastro de objeto encontrado");
        ...
        jLabel7.setText("Selecione o local:");
        ...
        jLabelAlunoServidor.setText("Data em que foi encontrado:");
        jPanelContent.add(jLabelAlunoServidor, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, 200, -1));
        ...
        jLabel10.setText("Se desejar, inclua uma foto:");
        jLabel10.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel10MouseClicked(evt);
            }
        });
        jPanelContent.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 470, 180, -1));
        ...
        jLabel22.setText("Imagem selecionada:");
        jPanelContent.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 520, 200, -1));
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        try {
            ...
            Logger.getLogger(CadastroEncontrado.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        String data;
        ...
        try {
            Cliente.out.writeObject("cadastroPublicacaoServidor");
            String resposta = (String) Cliente.in.readObject();
            if (resposta.equals("ok")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroEncontrado.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroEncontrado().setVisible(true);
            }
        });
    }
